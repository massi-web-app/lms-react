...
import {CardPlaceholderProps} from "@/app/_components/placeholders/card/card-placeholder.types";

export const CardPlaceholder: React.FC<CardPlaceholderProps> = ({count = 1, className}: CardPlaceholderProps) => {
