import {CourseAsideProps} from "@/app/(courses)/courses/[slug]/_components/course-aside/course-aside.types";
import {
    IconStudents,
    IconLevel,
    IconDoc,
...
type ExtentedCourseLevel = CourseLevel | 3;


const levelProgress: Record<ExtentedCourseLevel, number> = {
    0: 25,
    1: 50,
    2: 100,
    3: 75
